...
1. **Open an issue** using the appropriate template ([Bug Report](https://github.com/IUGO-Programming/iugo-ai/issues/new?template=bug_report.yml) or [Feature Request](https://github.com/IUGO-Programming/iugo-ai/issues/new?template=feature_request.yml))
...
```bash
git clone https://github.com/IUGO-Programming/iugo-ai.git
cd iugo-ai
go build -o gga .
```
...
Use [GitHub Discussions](https://github.com/IUGO-Programming/iugo-ai/discussions) — not issues — for questions, ideas, and general conversation.
