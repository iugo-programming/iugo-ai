...
- [x] Verify whether `iugo-agent-neutral-artifacts` already exists in `internal/model/types.go`, `internal/cli/validate.go`, `internal/tui/screens/persona.go`, `internal/components/persona/inject.go`, `internal/assets/`, `internal/catalog/agents.go`, and existing install/sync tests.
...
- [x] Keep explicit allowlists for IUGO direct-conversation persona/output-style assets.
...
### 1.7 RED: If missing, add `iugo-agent-neutral-artifacts` support tests
...
- [x] Add clear artifact/comment language-boundary wording without weakening IUGO direct conversation.
...
- [x] Inspect `internal/assets/*/persona-iugo-agent.md`, `internal/assets/generic/persona-neutral.md`, `internal/assets/claude/output-style-iugo-agent.md`, and `internal/assets/kimi/output-style-iugo-agent.md`.
- [x] Add artifact-boundary wording only if needed, while preserving IUGO direct-conversation Rioplatense teaching voice.
...
### 2.6 GREEN: If missing, implement `iugo-agent-neutral-artifacts` model, CLI, and TUI support
...
### 2.7 GREEN: If missing, implement `iugo-agent-neutral-artifacts` install and sync support
