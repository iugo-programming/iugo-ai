...
ok  	github.com/iugo-programming/iugo-ai/internal/components/sdd	(cached)
...
ok  	github.com/iugo-programming/iugo-ai/internal/components	1.792s
```
...
```text
go test ./... -coverprofile=/var/folders/k1/2nnhpdfx0wq8k6w8n2nqx9_h0000gn/T/opencode/iugo-ai-sdd-verify-pi-rerun.cover
# all packages passed; exit 0

go tool cover -func=/var/folders/k1/2nnhpdfx0wq8k6w8n2nqx9_h0000gn/T/opencode/iugo-ai-sdd-verify-pi-rerun.cover
