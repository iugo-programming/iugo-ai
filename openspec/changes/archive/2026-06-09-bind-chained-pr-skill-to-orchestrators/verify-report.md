...
ok  github.com/iugo-programming/iugo-ai/internal/assets         0.084s
ok  github.com/iugo-programming/iugo-ai/internal/components/sdd  60.808s
...
|----------|--------|----------|
| Orchestrator resolves chained-pr skill by registry name on chained delivery | PASS | All 11 templates contain the canonical binding sentence referencing `chained-pr` (registry skill `iugo-ai-chained-pr`) by name, with no hardcoded path |
