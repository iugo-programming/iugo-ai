...
1. `internal/assets/claude/persona-iugo-agent.md` — Claude variant (names `Skill` tool)
2. `internal/assets/opencode/persona-iugo-agent.md` — non-Claude variant
3. `internal/assets/generic/persona-iugo-agent.md` — non-Claude variant
4. `internal/assets/generic/persona-neutral.md` — non-Claude variant
5. `internal/assets/kiro/persona-iugo-agent.md` — non-Claude variant
6. `internal/assets/kimi/persona-iugo-agent.md` — non-Claude variant
...
9 persona goldens:
- `persona-claude-iugo-agent.golden`
- `persona-claude-neutral.golden`
- `persona-opencode-iugo-agent.golden`
- `persona-opencode-neutral.golden`
- `persona-windsurf-iugo-agent.golden`
- `persona-kiro-iugo-agent.golden`
- `persona-antigravity-iugo-agent.golden`
...
3. **Opencode user-skill mechanism** — currently out of scope; iugo-ai's skill-registry and `load` directive only ship to Claude Code, not to OpenCode's manual import flow.
