...
- [x] **T2** `[GREEN]` Fix `name:` field in `internal/assets/skills/chained-pr/SKILL.md`: change `name: iugo-ai-chained-pr` to `name: chained-pr`.
...
- [x] **T5** `[RED]` Add `TestPersonasContainContextualSkillLoadingDirective` to `internal/assets/assets_test.go`.
  - Check all 6 persona paths: `claude/persona-iugo-agent.md`, `opencode/persona-iugo-agent.md`, `generic/persona-iugo-agent.md`, `generic/persona-neutral.md`, `kiro/persona-iugo-agent.md`, `kimi/persona-iugo-agent.md`.
