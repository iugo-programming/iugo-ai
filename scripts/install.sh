...
#
# Usage:
#   curl -sL https://raw.githubusercontent.com/iugo-programming/iugo-ai/prod/scripts/install.sh | bash
#
# Or download and run:
#   curl -sLO https://raw.githubusercontent.com/iugo-programming/iugo-ai/prod/scripts/install.sh
#   chmod +x install.sh
#   ./install.sh
# ============================================================================
