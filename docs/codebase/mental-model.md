...
IUGO-AI is an ecosystem configurator for AI coding agents. It owns the installer, sync flows, adapters, and managed asset injection; it does not own the runtime behavior of external agents or Engram internals.

## What this project is

| It is | Evidence in this repo |
|---|---|
| Go CLI and Bubbletea TUI | `cmd/iugo-ai/main.go`, `internal/app/`, `internal/tui/` |
...
| A generic package manager | Dependency hints and installs support IUGO-AI components only. |
