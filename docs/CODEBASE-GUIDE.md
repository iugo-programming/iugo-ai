# IUGO-AI Codebase Guide

This guide helps maintainers find the right code path before changing IUGO-AI. It is an index, not a full API reference.
...
IUGO-AI is a Go CLI/TUI that configures AI coding agents. It installs and syncs managed assets such as SDD prompts, skills, MCP entries, permissions, personas, GGA support, and Engram wiring.

```text
User
  |
  v
iugo-ai CLI / Bubbletea TUI
  |
...
| [Sync and cloud](codebase/sync-and-cloud.md) | Separate IUGO-AI config sync from Engram memory/cloud sync. |
