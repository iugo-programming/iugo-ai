...
- Open a pull request on [IUGO-Programming/iugo-ai](https://github.com/IUGO-Programming/iugo-ai)
...
1. Confirm the issue has status:approved
   gh issue view <N> --repo IUGO-Programming/iugo-ai
...
```bash
gh pr checks --repo IUGO-Programming/iugo-ai <PR-number>
gh pr view --repo IUGO-Programming/iugo-ai <PR-number>
```

### Add a Label

```bash
gh pr edit <PR-number> --repo IUGO-Programming/iugo-ai --add-label "type:bug"
```
