...
Bind this to the dedicated `iugo-orchestrator` agent only. Do NOT apply it to executor phase agents such as `sdd-apply` or `sdd-verify`.
...
- Treat `agent.iugo-orchestrator.model` as authoritative when it is set.
