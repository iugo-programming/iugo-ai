...
Native Windsurf Workflow: `/sdd-new` is also available as a native Windsurf workflow installed by iugo-ai. It can be triggered from the Windsurf workflow panel.
