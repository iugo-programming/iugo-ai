...
// iugo-ai injects its sections via StrategyMarkdownSections markers.
...
// SystemPromptStrategy uses MarkdownSections: iugo-ai markers are injected
// into user_rules/iugo-ai.md without clobbering other user content.
