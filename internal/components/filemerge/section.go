...
const (
	markerPrefix = "<!-- iugo-ai:"
	markerSuffix = " -->"
	closePrefix  = "<!-- /iugo-ai:"
)

// legacyPersonaFingerprints are substrings that appear in the IUGO persona
...
// StripLegacyPersonaBlock removes a free-text IUGO persona block that was
// written to a markdown file outside of <!-- iugo-ai: --> markers.
//
...
// <!-- iugo-ai: --> marker). A fingerprint that exists only inside a marker
...
// written by the standalone ATL installer before iugo-ai superseded it.
...
// <!-- iugo-ai:sdd-orchestrator --> section, so keeping both wastes ~150
...
// Markers use HTML comments: <!-- iugo-ai:SECTION_ID --> ... <!-- /iugo-ai:SECTION_ID -->
